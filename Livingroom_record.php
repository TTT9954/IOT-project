   ...
   <!-- <div class="topnav">
    ...
    <table class="styled-table" id= "table_id_livingroom">
	  ...
	  <?php
		 ...
		 $sql = "SELECT id, Temp, Hum, PPM, Light, Timer, date, time FROM dbsensor_livingroom order by id desc";
...
<script>
      ...
      function apply_Number_of_Rows1() {
        var x = document.getElementById("number_of_rows_kitchen").value;
        records_per_page = x;       
        changePage(current_page);
      }
      //------------------------------------------------------------
