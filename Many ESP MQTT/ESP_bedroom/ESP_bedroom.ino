...
String topicsub = "thanhtu54/bedroom_from_Web"; // nhận dữ liệu ESP ở topic toannv10291/quat => APP WEB gửi toannv10291/quat
String topicpub = "thanhtu54/bedroom_from_ESP"; // gửi dữ liệu

const char* linkwrite = "http://thanhtu54.000webhostapp.com/ESPwrite_bedroom.php";
...
void ParseJson(String Data)
{
  ...
  else
  {
    ...
    else if (JSON1["Light_bedroom_timer"] == "1")
    {
        HenGioDen = 1;
        if (JSON1["Mode_on"] == "1")
        {
    ...
    else if (JSON1["Light_bedroom_timer"] == "0")
    {
       HenGioDen = 0;
    }
  }
...
{
  DataMqttJson  = "{\"Temp_bedroom\":\"" + String(DataND) + "\"," +
                  "\"Hum_bedroom\":\"" + String(DataDA) + "\"," +
                  "\"PPM_bedroom\":\"" + String(DataMQ135) + "\"," +
                  "\"Light_bedroom\":\"" + String(DataTB1) + "\"," +
                  "\"Light_bedroom_timer\":\"" + String(DataH1) + "\"}";
  Serial.println();
